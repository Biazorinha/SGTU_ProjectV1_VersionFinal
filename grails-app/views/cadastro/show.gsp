...
<header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
	<div class="navbar-nav-scroll">
		<ul class="navbar-nav bd-navbar-nav flex-row">
			...
			<li class="nav-item">
				<a class="nav-link" href="${createLink(uri:'/cadastro/createAdmin')}" onclick="ga('send', 'event', 'Navbar', 'Community links', 'Bootstrap');">Cadastar</a>
			</li>
		</ul>
	</div>
</header>
...
<div id="show-roteiro" class="container-fluid">
	<ul class="list-group list-group-flush">
		...
		<li class="list-group-item">
			<span id="description-label" class="property-label"><g:message code="cadastro.description.label" default="Feedback: " /></span>
			<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${cadastroInstance}" field="description"/></span>
		</li>
		<li class="list-group-item">
			<span id="roteiro-label" class="property-label"><g:message code="cadastro.roteiro.label" default="Roteiro: " /></span>
			<g:each in="${cadastroInstance.roteiro}" var="r">
...
<div class="form-control">
	<g:form url="[resource:cadastroInstance, action:'delete']" method="DELETE">
		<fieldset class="buttons">
			<g:link class="btn btn-bd-primary" action="edit" resource="${cadastroInstance}">Editar</g:link>
			<g:actionSubmit class="btn btn-bd-primary" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm(';" />
		</fieldset>
	</g:form>
</div>
</body>
